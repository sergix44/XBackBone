...
return [
    ...
    'mail.new_account_text_with_pw' => '%s 님 안녕하세요!<br>%s(<a href="%s">%s</a>) 에 대한 새 계정이 생성되었어요,<br><br>이름: %s<br>비밀번호: %s<br><br>다음 링크를 클랙하고 로그인하세요:<br><a href="%s">%s</a>',
    ...
    'default_lang_behavior' => '기본적으로 브라우저의 언어와 똑같이 설정할 거에요 (기본값: 영어).',
    'auto_set' => '자동 설정',
    'cancel' => '취소',
    'updates' => '업데이트',
    'upgrade' => '업그레이드',
